...
def create_yaml_config_loader(config_schema, default_config_path):
    """Create a configuration loader that can read configuration from .yaml file

    :param config_schema: Configuration schema (a subclass of cfg_loader.ConfigSchema)
